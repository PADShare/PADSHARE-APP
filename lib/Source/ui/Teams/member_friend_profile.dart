...
import 'package:padshare/Source/ui/Teams/search_members.dart';
...
class MemberProfile extends StatefulWidget {
  ...
  MemberProfile({@required this.user, @required this.userdata});
                        ...
                        children: [
                          ...
                          new Padding(padding: const EdgeInsets.only(top: 20),
                            child: new Container(
                              width: 150,
                              height: 150,
                              child: widget.user['userprofile'] ==null ? Container(
                                width: 100,
                                height: 100,
                                decoration: BoxDecoration(
                                ...
                                child: CircleAvatar(
                                  ...
                                  child: Center(child: Text(widget.user['user'][0].toUpperCase(),style: GoogleFonts.roboto(color: Colors.white54, fontSize: 40, fontWeight: FontWeight.w500),),),
                                ),
                              ) : Container(
                                width: 70,
                                height: 70,
                                decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        image: NetworkImage(widget.user['userprofile']),
                                        fit: BoxFit.cover
                                    )
                                ),
                              ),
                          ...
                          Padding(
                            ...
                            child: new Container(
                              ...
                              child:new Text(widget.user['user'] ?? '',style: GoogleFonts.roboto(color:Color(0xff666363), fontSize: 20, fontWeight: FontWeight.bold),),
                            ),
                          ),
                          SizedBox(height: 10,),
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              color: Color(0xffa3c314),
                              borderRadius: BorderRadius.circular(15)
                          ),
                          child: Center(
                            child: new Text("Already Member",style: TextStyle(color:Color(0xfff5f5f3),fontSize: 18, fontFamily: "PROXIMANOVA", fontWeight: FontWeight.w300),),
                          ),
                        ),
                      )
                          : InkWell(
                      ...
                      //       "requests" : FieldValue.arrayUnion([_auth.currentUser.uid])
                      //     }).then((value){
                      //       var snakBar = SnackBar(content: Text('You have sent the Request to ${widget.user['name']}', style: TextStyle(color: Colors.blue),),);
                      //
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Padding(
                              ...
                              child: new Text("FRIENDS",style: TextStyle(color:Color(0xfff5f5f3),fontSize: 20, fontFamily: "PROXIMANOVA", fontWeight: FontWeight.w200),),
                            ),
                          ),
                        ),

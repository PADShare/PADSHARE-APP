...
class PadsPage extends StatefulWidget{

  @override
  _PadsPageState createState() => _PadsPageState();
}

class _PadsPageState extends State<PadsPage> {
    ...
    return new Scaffold(
        ...
        body: NestedScrollView(
          ...
          body: isloading ? Center(child: CircularProgressIndicator(),) : new Container(
            ...
            // child: new Text("DATA"),
            child: padsShop.length == 0 ? Padding(

...
class FriendsProfile extends StatefulWidget {
  ...
  FriendsProfile({@required this.user, @required this.userdata});
                        ...
                        children: [
                            ...
                            child: new Container(
                              ...
                              child: widget.user['userprofile'] ==null ? Container(
                                ...
                                child: CircleAvatar(
                                  ...
                                  child: Center(child: Text(widget.user['name'][0].toUpperCase(),style: GoogleFonts.roboto(color: Colors.white54, fontSize: 40, fontWeight: FontWeight.w500),),),
                                ),
                              ) : Container(
                                width: 70,
                                height: 70,
                          ...
                          Padding(
                            ...
                            child: new Container(
                              ...
                              child:new Text(widget.user['name'] ?? '',style: GoogleFonts.roboto(color:Color(0xff666363), fontSize: 20, fontWeight: FontWeight.bold),),
                            ),
                          ),
                          SizedBox(height: 10,),

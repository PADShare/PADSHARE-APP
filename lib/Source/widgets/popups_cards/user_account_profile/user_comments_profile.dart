...
class InviteCommentUserToTeam extends StatefulWidget {
  final token;
  final userdata;

  InviteCommentUserToTeam({@required this.token, @required this.userdata});

  @override
  _InviteCommentUserToTeamState createState() => _InviteCommentUserToTeamState();
}

class _InviteCommentUserToTeamState extends State<InviteCommentUserToTeam> {
  var location;
